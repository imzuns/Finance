...
st.set_page_config(page_title="추추 도우미", layout="wide", page_icon="📊")
...
fig.add_trace(go.Bar(x=idx.index, y=idx["disparity"], name="이격도", marker_color="#22C55E"), row=2, col=1)
...
nav2.page_link("pages/2_종목_상세.py", label="→ 종목 상세 페이지로 이동", icon="📈")
